...
def main():
    ...
    myo.init(sdk_path=r'C:\Users\ThinkCentre\Desktop\Power\myo_sdk') # Compile Python binding to Myo's API
    ...
    gestures = ['fist', 'open', 'relax', 'index', 'thumb', 'middle', 'little', 'wrist_down', 'wrist_up', 'ring', 'wrist_left', 'wrist_right', 'ok']#, 'pron', 'supi'] # Classes to acquire data for
    trials_n = 25  # Number of trials for each class
