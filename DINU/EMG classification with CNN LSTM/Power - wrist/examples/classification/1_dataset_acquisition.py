...
def main():
    ...
    gestures = ['fist', 'open', 'relax', 'index', 'thumb', 'middle', 'little', 'wrist', 'ring', 'wrist_left', 'wrist_right']#, 'pron', 'supi'] # Classes to acquire data for
    trials_n = 20  # Number of trials for each class
