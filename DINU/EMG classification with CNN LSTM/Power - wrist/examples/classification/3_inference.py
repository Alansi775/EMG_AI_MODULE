...
servo_config = {
    ...
    'wrist':  {'pin': 11,  'relax': 90, 'left': 0, 'right': 180},
}
...
def main():
    ...
    if len(sys.argv) > 1: MODEL_FILE = sys.argv[1]
    if len(sys.argv) > 2: METADATA_FILE = sys.argv[2]
    ...
    print("Start performing gestures. Press Ctrl-C to stop.")
